            ...
            <div style="padding: 20px;">
                ...
                <div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                    ...
                    <div style="flex: 1; margin-bottom: 10px;">
                        ...
                        <p style="text-align: center;">Генерируйте изображения высокого разрешения из текстовых описаний с помощью стабильных диффузионных моделей. Вы можете указать текстовое описание, параметры генерации и получить изображение высокого качества.</p>
                    </div>
                    <div style="flex: 1; margin-bottom: 10px;">
                        <h2 style="text-align: center;">Улучшение изображений</h2>
                        <img src="https://example.com/real_esrgan.png" alt="Real-ESRGAN" width="100%">
                        <p style="text-align: center;">Улучшайте качество ваших изображений с помощью моделей RealESRGAN. Вы можете загрузить изображение, выбрать коэффициент масштабирования и получить изображение с улучшенным разрешением и качеством.</p>
                    </div>
                    <div style="flex: 1; margin-bottom: 10px;">
